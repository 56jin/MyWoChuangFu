...
@implementation GetIndentifyCodeMessage
-(void)dealloc
{
    [super dealloc];
}
...
- (NSString *)getRequest
{
    NSDictionary *headerData = [[NSDictionary alloc] initWithObjectsAndKeys:GetIndentifyCodeMessage_BIZCODE,@"bizCode",nil];
    
    NSString *requestClass = [[NSString alloc] initWithFormat:JSON_BODY_REUEST,[GetIndentifyCodeMessage_BIZCODE uppercaseString]];
...
+ (NSString*)getBizCode
{
    return GetIndentifyCodeMessage_BIZCODE;
}
