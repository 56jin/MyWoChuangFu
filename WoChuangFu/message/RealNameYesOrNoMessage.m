...
@implementation RealNameYesOrNoMessage
...
- (NSString *)getRequest
{
    NSDictionary *headerData = [[NSDictionary alloc] initWithObjectsAndKeys:RealNameYesOrNoMessage_BIZCODE,@"bizCode",nil];
    
    NSString *requestClass = [[NSString alloc] initWithFormat:JSON_BODY_REUEST,[RealNameYesOrNoMessage_BIZCODE uppercaseString]];
    ...
    NSDictionary *bodyData = [[NSDictionary alloc] initWithObjectsAndKeys:
                              ...
                              [requestInfo objectForKey:@"menuName"],@"menuName",
...
+ (NSString*)getBizCode
{
    return RealNameYesOrNoMessage_BIZCODE;
}
