...
@implementation IndentifyMessage
-(void)dealloc
{
    [super dealloc];
}
...
- (NSString *)getRequest
{
    NSDictionary *headerData = [[NSDictionary alloc] initWithObjectsAndKeys:IndentifyMessage_BIZCODE,@"bizCode",nil];
    
    NSString *requestClass = [[NSString alloc] initWithFormat:JSON_BODY_REUEST,[IndentifyMessage_BIZCODE uppercaseString]];
...
+ (NSString*)getBizCode
{
    ...
    return IndentifyMessage_BIZCODE;
}
