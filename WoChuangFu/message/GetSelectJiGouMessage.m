...
@implementation GetSelectJiGouMessage
...
- (NSString *)getRequest
{
    NSDictionary *headerData = [[NSDictionary alloc] initWithObjectsAndKeys:GetSelectJiGouMessage_BIZCODE,@"bizCode",nil];
    
    NSString *requestClass = [[NSString alloc] initWithFormat:JSON_BODY_REUEST,[GetSelectJiGouMessage_BIZCODE uppercaseString]];
...
+ (NSString*)getBizCode
{
    return GetSelectJiGouMessage_BIZCODE;
}
