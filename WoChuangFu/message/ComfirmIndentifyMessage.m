//
//  ComfirmIndentifyMessage.m
//  WoChuangFu
//
//  Created by 陈贵邦 on 15/6/23.
//  Copyright (c) 2015年 asiainfo-linkage. All rights reserved.
//

#import "ComfirmIndentifyMessage.h"

@implementation ComfirmIndentifyMessage
...
- (NSString *)getRequest
{
    NSDictionary *headerData = [[NSDictionary alloc] initWithObjectsAndKeys:ComfirmIndentifyMessage_BIZCODE,@"bizCode",nil];
    
    NSString *requestClass = [[NSString alloc] initWithFormat:JSON_BODY_REUEST,[ComfirmIndentifyMessage_BIZCODE uppercaseString]];
    ...
    NSDictionary *bodyData = [[NSDictionary alloc] initWithObjectsAndKeys:
                              ...
                              [requestInfo objectForKey:@"svcNum"],@"svcNum",
                              [requestInfo objectForKey:@"yzCode"],@"yzCode",
                    
                              [requestInfo objectForKey:@"methodType"],@"methodType",
                              nil];
...
+ (NSString*)getBizCode
{
    return ComfirmIndentifyMessage_BIZCODE;
}
