...
#import "ChoosePackageMessage.h"

@implementation ChoosePackageMessage
...
- (NSString *)getRequest
{
    NSDictionary *headerData = [[NSDictionary alloc] initWithObjectsAndKeys:CHOOSEPACKAGE_BIZCODE,@"bizCode",nil];
    
    NSString *requestClass = [[NSString alloc] initWithFormat:JSON_BODY_REUEST,[CHOOSEPACKAGE_BIZCODE uppercaseString]];
    ...
    NSDictionary *bodyData = [[NSDictionary alloc] initWithObjectsAndKeys:
                              ...
                              [requestInfo objectForKey:@"skuId"],@"skuId",
                              [requestInfo objectForKey:@"productId"],@"productId",
                              [requestInfo objectForKey:@"moduleId"],@"moduleId",
                              [requestInfo objectForKey:@"lowCost"],@"lowCost",
                              [requestInfo objectForKey:@"pkgId"],@"pkgId",nil];
