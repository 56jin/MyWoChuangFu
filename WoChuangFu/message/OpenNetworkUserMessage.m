...
@implementation OpenNetworkUserMessage
-(void)dealloc
{
    [super dealloc];
}
...
- (NSString *)getRequest
{
    NSDictionary *headerData = [[NSDictionary alloc] initWithObjectsAndKeys:OpenNetworkUserMessage_BIZCODE,@"bizCode",nil];
    
    NSString *requestClass = [[NSString alloc] initWithFormat:JSON_BODY_REUEST,[OpenNetworkUserMessage_BIZCODE uppercaseString]];
...
//                              [requestInfo objectForKey:@"sessionId"],@"sessionId",
                              ...
                              [requestInfo objectForKey:@"cDCardId"],@"cDCardId",
...
+ (NSString*)getBizCode
{
    ...
    return OpenNetworkUserMessage_BIZCODE;
}
