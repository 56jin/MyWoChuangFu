...
- (void)addSubviews
{
    ...
    _nameLable.frame = CGRectMake(LABLE_POSTION_COMMON_X,LABLE_NAME_POSTION_Y, LABLE_LENGTH_COMMON,35);
    _nameLable.font = FONT_SIZE(14.0);
    ...
    _descLable.frame = CGRectMake(LABLE_POSTION_COMMON_X, LABLE_NAME_POSTION_Y + 30, LABLE_LENGTH_COMMON,LABLE_COMMON_HEIGHT * 2);
    _descLable.font = FONT_SIZE(12.0);
    ...
    _discountPriceLable.frame = CGRectMake(LABLE_POSTION_COMMON_X, LABLE_COMMON_HEIGHT * 2+28, LABLE_PRICE_LENGTH,LABLE_COMMON_HEIGHT);
    ...
    _sailPriceLable.frame = CGRectMake(LABLE_POSTION_COMMON_X + LABLE_PRICE_LENGTH, LABLE_COMMON_HEIGHT * 2+28,LABLE_PRICE_LENGTH,LABLE_COMMON_HEIGHT);
    _sailPriceLable.font = FONT_SIZE(12.0);
...
- (void)setProduct:(ProductModel *)product
{
    ...
    switch ([_product.moduleId intValue])
    {
        ...
        {
            self.discountPriceLable.text = [NSString stringWithFormat:@"￥%@元",_product.sailPrice];
        ...
        {
            self.discountPriceLable.text = [NSString stringWithFormat:@"￥%@元",_product.discountPrice];
            self.sailPriceLable.text = [NSString stringWithFormat:@"￥%@元", _product.sailPrice];
            break;
        }
            // 宽带
        case DetailTypeNet:
        {
            ...
            self.discountPriceLable.text = [NSString stringWithFormat:@"￥%@～1800元",_product.sailPrice];
            self.sailPriceLable.hidden = YES;
            break;
        }
            // 包卡
