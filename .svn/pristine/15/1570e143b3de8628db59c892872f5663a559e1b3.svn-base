...
- (void)paginatorView:(SYPaginatorView *)paginatorView dragginToLeft:(NSInteger)pageIndex;
- (void)paginatorView:(SYPaginatorView *)paginatorView dragginToRight:(NSInteger)pageIndex;
