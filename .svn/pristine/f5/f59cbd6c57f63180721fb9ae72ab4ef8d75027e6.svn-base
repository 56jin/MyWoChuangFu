...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        UIView *viewS=[[UIView alloc] initWithFrame:CGRectMake(0, 0, 320, 64)];
        [self addSubview:viewS];
        
        UITapGestureRecognizer *oneFingerTwoTaps =[[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(hid:)] autorelease];
        [oneFingerTwoTaps setNumberOfTapsRequired:2];
        [oneFingerTwoTaps setNumberOfTouchesRequired:1];
        [viewS addGestureRecognizer:oneFingerTwoTaps];
        [viewS release];
//        UIButton *HidBtn=[UIButton buttonWithType:UIButtonTypeCustom];
//        if([UIScreen mainScreen].bounds.size.height>480){
//            HidBtn.frame=CGRectMake(182, [UIScreen mainScreen].bounds.size.height-332, 25.5, 25.5);
//        }else
//            HidBtn.frame=CGRectMake(182, [UIScreen mainScreen].bounds.size.height-288, 25.5, 25.5);
//        [HidBtn setBackgroundImage:[UIImage imageNamed:@"Hud_on.png"] forState:UIControlStateNormal];
//        [HidBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
//        HidBtn.titleLabel.font=[UIFont systemFontOfSize:13];
//        [HidBtn addTarget:self action:@selector(hid:) forControlEvents:UIControlEventTouchUpInside];
