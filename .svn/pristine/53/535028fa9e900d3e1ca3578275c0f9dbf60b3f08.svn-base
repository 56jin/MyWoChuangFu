#import "GetEvaluateMessage.h"

@implementation GetEvaluateMessage
...
- (NSString *)getRequest
{
    NSDictionary *headerData = [[NSDictionary alloc] initWithObjectsAndKeys:GETEVALUATE_BIZCODE,@"bizCode",nil];
    
    NSString *requestClass = [[NSString alloc] initWithFormat:JSON_BODY_REUEST,[GETEVALUATE_BIZCODE uppercaseString]];
    ...
    NSDictionary *bodyData = [[NSDictionary alloc] initWithObjectsAndKeys:
                              ...
                              [requestInfo objectForKey:@"productType"],@"productType",
