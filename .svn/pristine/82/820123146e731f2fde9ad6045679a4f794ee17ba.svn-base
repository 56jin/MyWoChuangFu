...
- (void)layoutVC
{
    ...
    indicatorView.frame = CGRectMake(webView.center.x,webView.center.y,0,0);
...
{
    [super viewDidLoad];
    [self.myWebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[self.productDetailUrl stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]]]];
}
