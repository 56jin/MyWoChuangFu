...
//    self.titleName.backgroundColor = [UIColor colorWithRed:107./255.
//                                                 green:190./255.
//                                                  blue:72./255.
//                                                 alpha:1.0f];
    
    self.titleName.backgroundColor = [UIColor orangeColor];
...
//        [self.doneButton setBackgroundImage:[ZSYPopoverListView normalButtonBackgroundImage] forState:UIControlStateNormal];
    ...
    [self.doneButton setBackgroundColor:[UIColor colorWithRed:107./255.
                                                        green:190./255.
                                                         blue:72./255.
                                                        alpha:1.0f]];
...
- (void)buttonWasPressed:(id)sender
{
    ...
    else
    {
        ...
        if (self.delegate && [self.delegate respondsToSelector:@selector(sureDone)]) {
            [self.delegate sureDone];
        }
    }
    if (block)
    {
